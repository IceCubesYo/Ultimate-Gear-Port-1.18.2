...
public enum ModArmorMaterials implements ArmorMaterial {
    ULTIMATE("ultimate", 51, new int[]{6, 12, 10, 6}, 20, SoundEvents.ARMOR_EQUIP_NETHERITE,
            2.75F, 0.1F, () -> Ingredient.of(ModItems.URANIUM_INGOT.get()));
    ...
    public String getName() {
        return ultimategearport.MOD_ID + ":" + this.name;
    }
